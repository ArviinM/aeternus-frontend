...
const NotFound: React.FC = () => {
  return (
    <div className="bg-gray-100 justify-center m-auto grid place-items-center h-screen font-sans">
      <div className="m-auto">
        ...
        <div className="mt-6 tracking-widest text-center">
          <span className="text-gray-500 text-6xl block">
            <span>4 0 4</span>
          </span>
          <span className="mt-6 text-gray-500 text-xl">
